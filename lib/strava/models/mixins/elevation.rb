  ...
  module Models
    module Mixins
      module Elevation
        ...
        def total_elevation_loss_in_feet
          total_elevation_gain_in_feet
        end

        def total_elevation_loss_in_meters
          total_elevation_gain_in_meters
        end

        def total_elevation_loss_in_meters_s
          total_elevation_gain_in_meters_s
        end

        def total_elevation_loss_in_feet_s
          total_elevation_gain_in_feet_s
        end

        def total_elevation_loss_s
          total_elevation_loss_in_meters_s
        end
      end
    end
  end
